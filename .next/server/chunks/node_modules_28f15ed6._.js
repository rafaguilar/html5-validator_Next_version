...
"[project]/node_modules/stylelint/lib/rules/declaration-property-value-keyword-no-deprecated/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const messages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$ruleMessages$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(ruleName, {
    ...
    rejected: (property, keyword)=>`Unexpected deprecated keyword "${keyword}" for property "${property}"`
});
const meta = {
...
/** @type {ReadonlyArray<[string, Record<string, string>]>} */ const COLOR_PROPERTIES = [
    ...__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$properties$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["singleValueColorProperties"].values()
].map((value)=>[
        value,
        DEPRECATED_COLORS
    ]);
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary, secondaryOptions)=>{
    return (root, result)=>{
        ...
        root.walkDecls((decl)=>{
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreKeywords', value)) return;
            ...
            parsedValue.walk((node)=>{
                ...
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxValue$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(node.value)) isStandardValue = false;
            });
...
//# sourceMappingURL=node_modules_28f15ed6._.js.map