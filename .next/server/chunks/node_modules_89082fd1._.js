...
"[project]/node_modules/stylelint/lib/rules/color-function-alias-notation/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        const targetFunctionCall = primary === 'with-alpha' ? WITHOUT_A_FUNCTION_CALL : WITH_A_FUNCTION_CALL;
        const targetFunctionName = primary === 'with-alpha' ? WITHOUT_A_FUNCTION_NAME : WITH_A_FUNCTION_NAME;
        root.walkDecls((decl)=>{
            ...
            parsedValue.walk((node)=>{
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$typeGuards$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isValueFunction"])(node) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxColorFunction$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(node)) return;
...
//# sourceMappingURL=node_modules_89082fd1._.js.map