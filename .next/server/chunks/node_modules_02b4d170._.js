...
"[project]/node_modules/stylelint/lib/rules/layer-name-pattern/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        const pattern = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$validateTypes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(primary) ? new RegExp(primary) : primary;
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].layerName, (atRule)=>{
            const { params } = atRule;
            if (!params) return;
            const parsedParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(params);
            parsedParams.walk((node)=>{
                check(node.type, node.value, node.sourceIndex, atRule);
            });
        });
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].importName, (atRule)=>{
            const { params } = atRule;
            if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["functionRegexes"].layer.test(params)) return;
            const parsedParams = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(atRule.params);
            parsedParams.walk((node)=>{
		 ...
		 */ function check(type, value, sourceIndex, atRule) {
            ...
            const index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"])(atRule) + sourceIndex;
...
//# sourceMappingURL=node_modules_02b4d170._.js.map