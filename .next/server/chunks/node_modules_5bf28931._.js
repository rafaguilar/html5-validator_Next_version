...
"[project]/node_modules/stylelint/lib/rules/import-notation/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ const fixer = (node, fixed, index)=>()=>{
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$setAtRuleParams$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(node, `${fixed}${restAtRuleParams}`);
    };
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].importName, checkAtRuleImportParams);
        /** @param {AtRule} atRule */ function checkAtRuleImportParams(atRule) {
            ...
            const index = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"])(atRule);
            const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(params);
            for (const node of parsed.nodes){
                ...
                if (primary === 'string') {
                    ...
                    const urlFunctionFull = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].stringify(node);
                    const urlFunctionArguments = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].stringify(node.nodes);
                    const quotedUrlFunctionFirstArgument = node.nodes[0]?.type === 'word' ? `"${urlFunctionArguments}"` : urlFunctionArguments;
                    const fix = fixer(atRule, quotedUrlFunctionFirstArgument, sourceEndIndex);
                    const message = messages.expected;
                    const messageArgs = [
                        urlFunctionFull,
                        quotedUrlFunctionFirstArgument
                    ];
                ...
                if (primary === 'url') {
                    ...
                    const path = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].stringify(node);
                    const urlFunctionFull = `url(${path})`;
                    const quotedNodeValue = type === 'word' ? `"${value}"` : `${node.quote}${value}${node.quote}`;
...
//# sourceMappingURL=node_modules_5bf28931._.js.map