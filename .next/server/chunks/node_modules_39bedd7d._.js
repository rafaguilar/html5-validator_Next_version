...
"[project]/node_modules/stylelint/lib/rules/font-family-no-duplicate-names/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
    ...
    return (root, result)=>{
        ...
        root.walkDecls(/^font(-family)?$/i, (decl)=>{
            ...
            for (const fontFamilyNode of fontFamilies){
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreFontFamilyNames', family)) {
                    continue;
                }
                ...
                if (isFamilyNameKeyword(fontFamilyNode)) {
                    if (keywords.has(family.toLowerCase())) {
                        complain(family, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["declarationValueIndex"])(decl) + fontFamilyNode.sourceIndex, rawFamily.length, decl);
                        continue;
                    }
                    keywords.add(family);
                    continue;
...
//# sourceMappingURL=node_modules_39bedd7d._.js.map