...
"[project]/node_modules/stylelint/lib/rules/number-max-precision/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary, secondaryOptions)=>{
    return (root, result)=>{
        const validOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$validateOptions$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(result, ruleName, {
            actual: primary,
            possible: [
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isNonNegativeInteger$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"]
            ]
        }, {
            optional: true,
            ...
            possible: {
                ...
                insideFunctions: [
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$validateObjectWithProps$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isNonNegativeInteger$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])
                ]
            }
        });
        if (!validOptions) {
        ...
        /** @type {Map<string, number>} */ const insideFunctions = new Map(Object.entries(secondaryOptions?.insideFunctions ?? {}));
        root.walkAtRules((atRule)=>{
            if (atRule.name.toLowerCase() === 'import') {
                return;
            }
            check(atRule, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$getAtRuleParams$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(atRule));
        });
        root.walkDecls((decl)=>{
            check(decl, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["declarationValueIndex"], (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$getDeclarationValue$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(decl));
        });
        /**
		 ...
		 */ function walker(node, getIndex, componentValue, state) {
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(componentValue)) {
                return;
            }
            const [tokenType, raw, startIndex, endIndex, parsedValue] = componentValue.value;
            if (tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Number && tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Dimension && tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Percentage) {
                return;
            }
            ...
            if (tokenType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Dimension) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreUnits', unit)) {
                    return;
                }
            } else if (tokenType === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Percentage) {
                unitStringLength = 1;
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreUnits', '%')) {
                    return;
                }
            }
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$report$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
                ...
                messageArgs: [
                    parsedValue.value,
                    parsedValue.value.toFixed(state.precision)
                ]
            });
        }
        /**
		 ...
		 */ function precisionInsideFunction(functionName, currentPrecision) {
            ...
            for (const [name, precision] of insideFunctions){
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$matchesStringOrRegExp$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(functionName, name)) {
                    return precision;
                }
            }
...
//# sourceMappingURL=node_modules_8f6846c9._.js.map