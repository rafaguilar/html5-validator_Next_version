...
"[project]/node_modules/stylelint/lib/utils/getSchemeFromUrl.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 * @returns {string | null}
 */ __turbopack_context__.s({
    "default": (()=>getSchemeFromUrl)
});
function getSchemeFromUrl(urlString) {
    let protocol = null;
    try {
...
"[project]/node_modules/stylelint/lib/rules/function-url-scheme-allowed-list/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$getSchemeFromUrl$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/stylelint/lib/utils/getSchemeFromUrl.mjs [app-route] (ecmascript)");
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        root.walkDecls((decl)=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$functionArgumentsSearch$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(decl.toString().toLowerCase(), 'url', (args, index)=>{
                const unspacedUrlString = args.trim();
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxUrl$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(unspacedUrlString)) {
                    return;
                }
                const urlString = unspacedUrlString.replace(/^['"]+|['"]+$/g, '');
                const scheme = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$getSchemeFromUrl$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(urlString);
                if (scheme === null) {
                    return;
                }
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$matchesStringOrRegExp$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(scheme, primary)) {
                    return;
                }
...
//# sourceMappingURL=node_modules_7a1068b7._.js.map