...
"[project]/node_modules/stylelint/lib/rules/lightness-notation/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const LIGHTNESS_ZERO_TO_ONE_RANGE_FUNCS = new Set([
    'oklch',
    'oklab'
]);
const LIGHTNESS_ZERO_TO_HUNDRED_RANGE_FUNCS = new Set([
    'lch',
    'lab'
]);
...
const HAS_LIGHTNESS_COLOR_FUNC = new RegExp(`\\b(?:${[
    ...LIGHTNESS_FUNCS
].join('|')})\\(`, 'i');
    ...
    return (root, result)=>{
        ...
        root.walkDecls((decl)=>{
            ...
            parsedValue.walk((node)=>{
                ...
                if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxValue$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(unfixedValue)) return;
                const dimension = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].unit(unfixedValue);
                if (!dimension) return;
                ...
                const fixedValue = primary === 'percentage' ? asPercentage(unfixedValue, functionName) : asNumber(unfixedValue, functionName);
...
//# sourceMappingURL=node_modules_f79ee35a._.js.map