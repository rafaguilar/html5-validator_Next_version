...
"[project]/node_modules/stylelint/lib/rules/custom-property-no-missing-var-function/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @typedef {import('postcss-value-parser').Node} Node */ // Properties that can receive a custom-ident
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        /** @type {Set<string>} */ const knownCustomProperties = new Set();
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].propertyName, ({ params })=>{
        ...
        root.walkDecls((decl)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$postcss$2d$value$2d$parser$2f$lib$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(value).nodes.forEach((childNode)=>{
		 ...
		 */ function check(node, decl) {
            if (node.type === 'function') {
                ...
                if (name === 'var') args = node.nodes.slice(1);
                    ...
                    const mustDrill = child && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isVarFunction$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(child);
...
//# sourceMappingURL=node_modules_5b0fad56._.js.map