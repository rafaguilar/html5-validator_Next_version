...
"[project]/node_modules/stylelint/lib/rules/keyframe-selector-notation/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const PERCENTAGE_SELECTORS = new Set([
    '0%',
    '100%'
]);
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
		 ...
		 */ const optionFuncs = {
            keyword: {
                expFunc: (selector)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$keywords$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyframeSelectorKeywords"].has(selector),
            ...
            'percentage-unless-within-keyword-only-block': {
                expFunc: (selector, selectorsInBlock)=>{
                    if (selectorsInBlock.every((s)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$keywords$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyframeSelectorKeywords"].has(s))) return true;
 ...
 */ function parseKeyframeSelector(selector) {
    const relevantNodes = selector.nodes.filter((node)=>{
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$node_modules$2f$postcss$2d$selector$2d$parser$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].isComment(node)) return false;
        if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$node_modules$2f$postcss$2d$selector$2d$parser$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].isCombinator(node) && node.value.trim() === '') return false;
        return true;
    });
    if (relevantNodes.length !== 1) return;
    if (!relevantNodes.every(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$node_modules$2f$postcss$2d$selector$2d$parser$2f$dist$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].isTag)) return;
    ...
    if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$keywords$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["keyframeSelectorKeywords"].has(normalizedSelector) && !PERCENTAGE_SELECTORS.has(normalizedSelector)) {
        return;
    }
    return [
        keyframeSelector,
 ...
 */ function getFromMap(map, key) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$validateTypes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assertString"])(value);
    return value;
}
/**
...
//# sourceMappingURL=node_modules_e4f534a7._.js.map