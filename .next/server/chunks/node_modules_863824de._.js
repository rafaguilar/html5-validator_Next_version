...
"[project]/node_modules/stylelint/lib/rules/font-family-name-quotes/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 */ function isSystemFontKeyword(font) {
    if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$keywords$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prefixedSystemFonts"].has(font)) {
        return true;
    }
 ...
 */ const makeMutableFontFamilies = (fontFamilies, decl)=>{
    ...
    fontFamilies.forEach((fontFamily, idx)=>{
        ...
        /** @type {MutableNode} */ const newNode = {
            name,
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        root.walkDecls(/^font(-family)?$/i, (decl)=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxValue$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(decl.value)) {
                return;
            }
            let fontFamilyNodes = makeMutableFontFamilies((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$findFontFamily$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(decl.value), decl);
		 ...
		 */ function checkFamilyName(fontFamilyNode, decl) {
            ...
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isVariable$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(rawFamily)) {
                return;
            }
            // Disallow quotes around (case-insensitive) keywords
            // and system font keywords in all cases
            if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$keywords$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fontFamilyKeywords"].has(family.toLowerCase()) || isSystemFontKeyword(family)) {
                if (hasQuotes) {
		 ...
		 */ function complain(messageType, fontFamilyNode, decl) {
            ...
            const fix = ()=>{
                return messageType === 'expected' ? fontFamilyNode.addQuotes() : fontFamilyNode.removeQuotes();
            };
...
//# sourceMappingURL=node_modules_863824de._.js.map