...
"[project]/node_modules/stylelint/lib/rules/custom-property-pattern/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        const regexpPattern = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$validateTypes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isString"])(primary) ? new RegExp(primary) : primary;
        /**
		 * @param {string} property
		 * @returns {boolean}
		 */ function check(property) {
            return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isCustomProperty$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(property) || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isStandardSyntaxProperty$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(property) || regexpPattern.test(property.slice(2));
        }
        root.walkDecls((decl)=>{
            ...
            if (VAR_FUNC_REGEX.test(value)) {
                ...
                parsedValue.walk((node)=>{
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isVarFunction$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(node)) return;
                    const { nodes } = node;
                    const firstNode = nodes[0];
                    if (!firstNode || check(firstNode.value)) return;
                    complain((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["declarationValueIndex"])(decl) + firstNode.sourceIndex, firstNode.value, decl);
                });
            }
        ...
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].propertyName, (atRule)=>{
            ...
            complain((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"])(atRule), propName, atRule);
        });
        /**
		 * @param {number} index
...
//# sourceMappingURL=node_modules_43abcbde._.js.map