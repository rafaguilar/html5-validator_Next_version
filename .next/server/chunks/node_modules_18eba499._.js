...
"[project]/node_modules/stylelint/lib/rules/unit-no-unknown/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
const units = new Set(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$reference$2f$units$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["units"]); // a copy that is safe to mutate
    ...
    return (root, result)=>{
		 ...
		 */ const tokenizeIfValueMightContainUnknownUnits = (value)=>{
            ...
            const hasUnknownUnits = tokens.some((token)=>{
                return token[0] === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Dimension && !units.has(token[4].unit.toLowerCase());
            });
		 ...
		 */ const check = (node, getIndex, componentValue, state)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFunctionNode"])(componentValue)) {
                ...
                if (nameLowerCase === 'url' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreFunctions', name)) {
                    state.ignored = true;
                    return;
                }
                if (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$vendor$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].unprefixed(nameLowerCase) === 'image-set') {
                    state.allowX = true;
                    return;
                }
                return;
            ...
            if (tokenType !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Dimension) return;
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreUnits', tokenValue.unit)) return;
        ...
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].mediaName, (atRule)=>{
            ...
            if (!tokens) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$media$2d$query$2d$list$2d$parser$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseFromTokens"])(tokens).forEach((mediaQuery)=>{
                const initialState = {
                    ignored: false,
                    allowX: false
                };
                mediaQuery.walk(({ node, state })=>{
                    ...
                    } else if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFunctionNode"])(node) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(node)) {
                        check(atRule, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"], node, state);
                    }
                }, initialState);
            });
        });
        root.walkDecls((decl)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["walk"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseListOfComponentValues"])(tokens), ({ node, state })=>{
                if (!state) return;
                if (state.ignored) return;
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFunctionNode"])(node) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(node)) {
                    check(decl, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["declarationValueIndex"], node, state);
                }
            }, initialState);
        });
    };
...
//# sourceMappingURL=node_modules_18eba499._.js.map