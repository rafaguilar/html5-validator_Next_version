...
"[project]/node_modules/stylelint/lib/rules/declaration-property-value-allowed-list/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary)=>{
    return (root, result)=>{
        ...
        root.walkDecls((decl)=>{
            ...
            const propPatterns = propKeys.filter((key)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$matchesStringOrRegExp$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(unprefixedProp, key));
            if (propPatterns.length === 0) {
                return;
            }
            if (propPatterns.some((pattern)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(primary, pattern, value))) {
                return;
            }
...
//# sourceMappingURL=node_modules_stylelint_lib_e5de9425._.js.map