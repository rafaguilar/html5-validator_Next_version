...
"[project]/node_modules/stylelint/lib/utils/hasDimension.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>hasDimension)
});
...
"[project]/node_modules/stylelint/lib/utils/isUnicodeRangeDescriptor.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "default": (()=>isUnicodeRangeDescriptor)
});
...
function isUnicodeRangeDescriptor(decl) {
    ...
    if (!parent || !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$typeGuards$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isAtRule"])(parent)) {
        return false;
    }
...
"[project]/node_modules/stylelint/lib/rules/unit-disallowed-list/index.mjs [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$hasDimension$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/stylelint/lib/utils/hasDimension.mjs [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isUnicodeRangeDescriptor$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/stylelint/lib/utils/isUnicodeRangeDescriptor.mjs [app-route] (ecmascript)");
...
/** @type {import('stylelint').CoreRules[ruleName]} */ const rule = (primary, secondaryOptions)=>{
    return (root, result)=>{
		 ...
		 */ function componentValueIsIgnored(componentValue) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isFunctionNode"])(componentValue)) {
                return false;
            }
            const name = componentValue.getName().toLowerCase();
            return name === 'url' || (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(secondaryOptions, 'ignoreFunctions', name);
        }
        /**
		 ...
		 */ function check(node, getIndex, componentValue, input, options) {
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(componentValue)) return;
            if (componentValue.value[0] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Dimension) return;
            ...
            if (options && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$optionsMatches$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(options, lowerCaseUnit, input)) return;
        ...
        root.walkAtRules(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$regexes$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleRegexes"].mediaName, (atRule)=>{
            const params = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$getAtRuleParams$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(atRule);
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$hasDimension$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(params)) return;
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$media$2d$query$2d$list$2d$parser$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseFromTokens"])(tokenizeWithoutPercentages(params)).forEach((mediaQuery)=>{
                /** @type {{ mediaFeatureName: string | undefined }} */ const initialState = {
                ...
                mediaQuery.walk(({ node, state })=>{
                    ...
                    if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(node)) return;
                    check(atRule, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atRuleParamIndex"], node, state.mediaFeatureName, secondaryOptions?.ignoreMediaFeatureNames);
                }, initialState);
            });
        });
        root.walkDecls((decl)=>{
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$isUnicodeRangeDescriptor$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(decl)) return;
            ...
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$hasDimension$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(value)) return;
            const initialState = {
                ignored: false
            };
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["walk"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseListOfComponentValues"])(tokenizeWithoutPercentages(value)), ({ node, state })=>{
                if (!state) return;
                if (state.ignored) return;
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$parser$2d$algorithms$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isTokenNode"])(node)) {
                    check(decl, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$stylelint$2f$lib$2f$utils$2f$nodeFieldIndices$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["declarationValueIndex"], node, decl.prop, secondaryOptions?.ignoreProperties);
                    return;
                }
 ...
 */ function tokenizeWithoutPercentages(css) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tokenize"])({
        css
    }).map((x)=>{
        if (x[0] !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["TokenType"].Percentage) return x;
        return [
            ...
            x[3],
            {
                value: x[4].value,
                unit: '%',
                type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$csstools$2f$css$2d$tokenizer$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NumberType"].Number
            }
        ];
    });
}
...
//# sourceMappingURL=node_modules_a95668f4._.js.map